...
int main() { 
    ...
    if (chi_square > chi_critical) { 
        printf("The random numbers do not pass the chi-square test at 0.05 significance level.\n"); 
    } 
    else { 
        printf("The random numbers pass the chi-square test at 0.05 significance level.\n"); 
    } 
    return 0; 
} 
